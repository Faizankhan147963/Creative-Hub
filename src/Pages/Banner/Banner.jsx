    ...
    <div className="min-h-screen bg-white p-4 md:p-8 lg:p-12" style={{ userSelect: "none" }}>
      <div className="mx-auto container py-16">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-black tracking-tight md:text-6xl lg:text-7xl">
              ...
              <br />
              and <span className="inline-block rounded-full bg-[#7FFF00] px-6 py-2">Innovative</span>
              <br />
              IT Solutions
            </h1>
          </div>
          ...
          <Link to={"/service"}>
            <button className="rounded-full bg-[#7FFF00] px-8 py-3 font-semibold text-black transition-transform cursor-pointer hover:bg-black hover:text-[#7fff00]">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {/* Web & App Development */}
          <Link className="rounded-3xl bg-[#7FFF00] p-6" to={'/service/Web & App Development'}>
            <div className="mb-4">
          ...
          {/* Cloud & Cybersecurity */}
          <Link className="rounded-3xl bg-[#7FFF00] p-6" to={'/service/Cloud & Security'}>
            <div className="mb-4">
              <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor">
