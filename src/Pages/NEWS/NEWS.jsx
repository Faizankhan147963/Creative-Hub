...
const NEWS = () => {
  ...
  return (
    <div className="min-h-screen    px-4 py-16">
      ...
      {/* Top Banner */}
      <div className="mb-20 rounded-3xl bg-[#7FFF00] p-8 md:p-12 container mx-auto">
      ...
      <div className="mx-auto container ">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-6 text-4xl font-black md:text-5xl lg:text-6xl">
            Latest from
            <br />
            <span className="inline-block rounded-full bg-[#7FFF00] px-6 py-2">Client's</span> Blog
          </h2>
