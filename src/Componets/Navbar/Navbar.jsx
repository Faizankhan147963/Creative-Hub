        ...
        <div className="container mx-auto md:px-0 px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-8">
              ...
              <Link to="/help" className="text-sm font-medium text-white hover:text-[#7FFF00]">
                Help & Support
              </Link>
            </div>
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-4">
              <Link
                to={"/contact"}
                className="text-sm font-medium px-4 py-2 bg-[#7FFF00] hover:text-black hover:bg-white text-gray-700 rounded-full flex items-center space-x-2 transition-all duration-300"
              >
            ...
            <div className="lg:hidden">
              <button className="text-white hover:text-[#7FFF00]" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
          ...
          <div className="flex flex-col h-full relative overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-800">
              <Link to="/" className="flex items-center" onClick={() => setMobileMenuOpen(false)}>
                ...
                <span className="bg-[#7FFF00] text-black px-2 mx-1 text-xl font-bold">CAREER</span>
              </Link>
            </div>
            ...
            <div className="flex-1 overflow-hidden relative">
              ...
              >
                <div className="flex-1 overflow-y-auto py-4">
                  <nav className="flex flex-col space-y-2 px-4">
                    <Link
                      to="/"
                      className="text-white hover:text-[#7FFF00] py-2 text-lg font-medium"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      Home
                    </Link>
                    ...
                    <button
                      className="flex items-center justify-between text-white hover:text-[#7FFF00] py-2 text-lg font-medium"
              ...
              >
                <div className="p-4 border-b border-gray-800 flex items-center">
                  <button className="flex items-center text-white hover:text-[#7FFF00]" onClick={goBackToMainMenu}>
                  ...
                  <nav className="flex flex-col space-y-3">
                    {[
                      ...
                      <button
                        ...
                        className="flex items-center justify-between text-white hover:text-[#7FFF00] py-2 border-b border-gray-800"
                      >
                        <span>{label}</span>
                        <ChevronRight className="h-5 w-5" />
                      </button>
                ...
                <div className="flex-1 overflow-y-auto p-4">
                  ...
                  <nav className="flex flex-col space-y-4">
                    <div className="border-b border-gray-800 pb-4">
                      ...
                      <a href="#" className="text-[#7FFF00] text-sm hover:underline">
                        Learn more →
                      </a>
                    </div>
                    <div className="border-b border-gray-800 pb-4">
              ...
              {["web-development", "web-design", "app-development", "app-design", "seo-marketing"].map(
                (subcategory) => (
                  ...
                  >
                    <div className="p-4 border-b border-gray-800 flex items-center">
                      <button className="flex items-center text-white hover:text-[#7FFF00]" onClick={goBackToSubmenu}>
                        <ChevronLeft className="h-5 w-5 mr-2" />
                      ...
                      {subcategory === "web-development" && (
                        <div>
                          ...
                          <div className="flex flex-col space-y-3">
                            <a href="#" className="text-white hover:text-[#7FFF00] py-2 border-b border-gray-800">
                              Frontend Development (React, Vue, Angular)
                            </a>
                            <a href="#" className="text-white hover:text-[#7FFF00] py-2 border-b border-gray-800">
                              Backend Development (Node.js, Laravel)
            ...
            <div className="p-4 border-t border-gray-800">
              <Link
                to={"/contact"}
                className="w-full text-center font-medium px-4 py-3 bg-[#7FFF00] hover:bg-white text-gray-700 rounded-full flex items-center justify-center space-x-2 transition-all duration-300"
                onClick={() => setMobileMenuOpen(false)}
              >
                <AiOutlinePhone className="text-lg rotate-90" />
                <span className="font-bold">Contact With Us</span>
